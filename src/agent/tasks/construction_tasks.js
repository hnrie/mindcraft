 ...
 * @param roomMaterials list of materials to be used for the generated rooms.
...
export function proceduralGeneration(m = 20,
                                     ...
                                     roomMaterials = ["stone", "terracotta", "quartz_block", "copper_block", "purpur_block"]) {
    // Build 3D space
...
function getBlockName(bot, coordinate) {
